...
import { Logo } from "@/icons/brands/index";

const NextJsSmall: React.FC<Logo> = ({ className, width = 30 }) => (
  <svg viewBox="0 0 180 180" width={width} className={className}>
    <mask
      height="180"
      id=":r8:mask0_408_134"
